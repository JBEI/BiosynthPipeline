...
def test_cryptofolione():
    ...
    with open(f'./test_molecules/{target_name}_results/{target_name}_{pathway_sequence[0].capitalize()}_only.txt', 'r') as file:
