...
#        # Intramolecular?
    ...
    OperatorSmarts("Hydration of Alkene, Ethers from Addition of Alcohols to Alkenes", 
                   "[C+0:1]=[C+0:2].[O+0!H0;!$(*-C=O):3]>>[*:1][*:2][*:3]",
                   (1, 1),(1, )),
    OperatorSmarts("Ethers from Addition of Alcohols to Alkenes, Intramolecular", 
...
#        # may need enthalpy correction
    ...
    OperatorSmarts("Friedel–Crafts Reaction with Alkenes, Intramolecular", 
                   "([c+0H:1].[C+0:2]=[C+0:3])>>[*:1][*:2][*:3]",
                   (1, ),(1, )),             
    # Heck Reaction      normally with haloalkene or haloarene, but possible with alkyl halides: doi.org/10.1039/C4CC00297K
    OperatorSmarts("Heck Reaction", 
                   "[C+0:1]=[C+0!H0:2].[C,c;+0:3][F,Cl,Br,I;+0:4]>>[*:1]=[*:2][*:3].[*:4]",
                   (1, 1),(1, 1)),
    OperatorSmarts("Heck Reaction, Intramolecular", 
                   "([C+0:1]=[C+0!H0:2].[C,c;+0:3][F,Cl,Br,I;+0:4])>>[*:1]=[*:2][*:3].[*:4]", 
                   (1, ),(1, 1),
                   ring_issue = True),
...
#           # produces same result as Wurtz reaction, may be redundant? Not sure if intramolecular possible for Suzuki coupling
    ...
    OperatorSmarts("Electrophilic Aromatic Alkylation with Alcohols", 
                   ...
                   (1, 1),(1, 1)),
    OperatorSmarts("Electrophilic Aromatic Alkylation with Alcohols, Intramolecular", # Intramolecular, Carboxylic Acids Can Participate
